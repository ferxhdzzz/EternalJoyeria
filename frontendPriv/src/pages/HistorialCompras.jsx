...
const HistorialCompras = () => {
  ...
  const filteredSales = sales.filter((sale) => {
    ...
    // CORRECCIÓN RECOMENDADA: Usar la referencia directa sale.idCustomers
                ...
                <div key={sale._id} className="sale-card">
                  <div className="sale-header">
                    <div className="sale-customer-info">
                      {/* CORRECCIÓN DE ACCESO AL CLIENTE */}
                      <h3>
                  ...
                  <div className="products-section">
                    ...
                    <div className="products-list">
                      {sale.idOrder?.products?.map((product, index) => {
                        // 💡 Lógica segura para Subtotal (ya funciona, pero es más limpio)
                        const subtotalAmount = ((product.subtotalCents || 0) / 100) || (product.subtotal || 0);
                        
                        // 💡 Acceso al Nombre del Producto
                        const productName = product.productId?.name   ||  "Producto eliminado    "; 
                        
                        return (
                          <div key={index} className="product-item">
                            <p>
                              {/* Usamos productName para ver si el populate está fallando */}
