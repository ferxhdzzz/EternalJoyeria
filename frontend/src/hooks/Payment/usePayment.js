...
// ------------------------------------------------
// helper request (Mantenido igual)
// ------------------------------------------------
...
    // ------------------------------------------------
    // Validaciones paso 1 (Mantenido igual)
    // ------------------------------------------------
    const validateStep1 = () => {
        const newErrors = {};
...
    // ------------------------------------------------
    // Cargar o crear carrito (Mantenido igual)
    // ------------------------------------------------
...
    // ------------------------------------------------
    // Sincronizar items (Mantenido igual)
    // ------------------------------------------------
...
    // ------------------------------------------------
    // CREAR ORDEN PENDIENTE + REGISTRAR VENTA (Mantenido igual)
    // ------------------------------------------------
...
    // ------------------------------------------------
    // Admin marcar pagada (Mantenido igual)
    // ------------------------------------------------
...
    // ------------------------------------------------
    // Navegación pasos (Mantenido igual)
    // ------------------------------------------------
    const nextStep = async () => {
        if (step === 1) {
            if (!validateStep1()) return false;
            await saveAddresses(); // Vuelve a guardar con los campos correctos
            setStep(2);
            return true;
        }
        if (step < 3) {
...
    // ------------------------------------------------
    // Finalizar compra (Manejo de PayPal/Métodos directos) (Mantenido igual)
    // ------------------------------------------------
...
    // ------------------------------------------------
    // Botón "Siguiente" dentro del modal (Transferencia/Link) (Mantenido igual)
    // ------------------------------------------------
...
    // ------------------------------------------------
    // cargar carrito al iniciar (Mantenido igual)
    // ------------------------------------------------
    useEffect(() => {
