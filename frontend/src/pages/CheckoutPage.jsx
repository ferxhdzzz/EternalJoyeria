...
// ======================
// SVG Super cute (Mantenido igual)
// ======================
const TicketEdge = () => (
...
    // ======================
    // HANDLERS DEL FLUJO (Mantenido igual)
    // ======================
...
                                {/* Bloque donde se mostrará la dirección guardada */}
                                <div className="shipping-address-summary">
                                    <h4 style={{ marginBottom: '5px' }}>Dirección de Envío:</h4>
                                    {order?.shippingAddress && (
                                        <>
                                            <p>
                                                <strong>{order.shippingAddress.recipientName || order.shippingAddress.name || 'Nombre No Disp.'}</strong> 
                                                ({order.shippingAddress.phone || 'Teléfono No Disp.'})
                                            </p>
