...
import ProfilePhotoUpload from "../components/Register/ProfilePhotoUpload";
...
const Registro = () => {
  ...
  // Estado del formulario simplificado y limpio
  ...
  // Función principal para avanzar al siguiente paso
  const handleNext = useCallback(async (e) => {
    ...
    // Si estamos en el paso 2, registrar el cliente
    if (currentStep === 2) {
  ...
  // Simulación de tomar foto (placeholder)
  const handleTakePhoto = useCallback(() => {
    console.log("Función de tomar foto - Por implementar");
    // Aquí iría la lógica real para tomar foto
  }, []);
