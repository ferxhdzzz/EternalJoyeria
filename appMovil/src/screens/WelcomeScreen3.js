...
const WelcomeScreen3 = ({ onNext }) => {
  ...
  const handleStart = () => {
    // Animación de salida antes de navegar - más suave para transición al login
    Animated.parallel([
      Animated.timing(fadeAnim, {
        toValue: 0,
        duration: 500, // Aumentado de 300 a 500 para transición más suave
        useNativeDriver: true,
      }),
      Animated.timing(slideAnim, {
        toValue: -80, // Aumentado de -50 a -80 para movimiento más pronunciado
        duration: 500, // Aumentado de 300 a 500 para transición más suave
        useNativeDriver: true,
      }),
      Animated.timing(buttonScaleAnim, {
        toValue: 0.9, // Añadido scale down del botón
        duration: 400,
        useNativeDriver: true,
      }),
    ]).start(() => {
    ...
    <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
      <View style={styles.imageSection}>
        ...
        >
          ...
          >
            <Image
              source={require('../../assets/welcome-images/bienvenida3.png')}
...
const styles = StyleSheet.create({
  ...
  imageContainer: {
    ...
    borderRadius: 20,
    overflow: 'hidden',
    marginTop: height * 0.08, // Reducido de 0.12 a 0.08 para mover la imagen más arriba
