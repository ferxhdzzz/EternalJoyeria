...
const styles = StyleSheet.create({
  ...
  imageContainer: {
    width: width * 0.9, // Aumentado de 0.85 a 0.9 para imagen más grande
    height: height * 0.55, // Aumentado de 0.5 a 0.55 para imagen más grande
    borderRadius: 20,
    overflow: 'hidden',
    marginTop: height * 0.15, // Aumentado de 0.12 a 0.15 para mover imagen un poquito más abajo
